        ...
        elem.addEventListener("click", function () {
            ...
            if (melyik === "Zero waste kollekció") {
                $("#zero").addEventListener(
                    "click",
                    galeriaFeltoltAdatokkal(zeroWasteKepek)
                );
                szovegKiiras(0);
            } else if (melyik === "Kreatív kollekció") {
                $("#ing").addEventListener(
                    "click",
                    galeriaFeltoltAdatokkal(ingKepek)
                );
                szovegKiiras(1);
